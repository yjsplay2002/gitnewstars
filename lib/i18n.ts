...
export const translations = {
  ko: {
    ...
    tabBlog: "블로그",
    blogBadge: "기술 블로그",
    blogTitle: "GitNewStars 블로그",
    blogSubtitle: "AI 코딩 도구 사용기, 모델 분석, 자동화 파이프라인 구축 기록.",
    blogEmpty: "아직 글이 없습니다.",
    blogWrite: "글 쓰기",
    blogEdit: "수정",
    blogDelete: "삭제",
    blogDeleteConfirm: "이 글을 삭제할까요? 되돌릴 수 없습니다.",
    blogBack: "← 블로그로 돌아가기",
    blogUpdatedLabel: "수정됨",
    blogEditorTitleNew: "새 글 쓰기",
    blogEditorTitleEdit: "글 수정",
    blogFieldTitle: "제목",
    blogFieldSlug: "슬러그 (URL, 영문 소문자·하이픈)",
    blogFieldTags: "태그 (쉼표 구분, 최대 5개)",
    blogFieldBody: "본문 (마크다운)",
    blogPreview: "미리보기",
    blogEditorHint: "마크다운 지원: 제목(#), 굵게(**), 코드(```), 링크, 이미지, 리스트, 인용(>)",
    blogPublish: "발행",
    blogSaveDraft: "임시저장 (비공개)",
    blogSaving: "저장 중…",
    blogSaved: "저장됨!",
  ...
  en: {
    ...
    blogSubtitle:
      "Field notes on AI coding tools, model analysis, and automation pipelines.",
    blogEmpty: "No posts yet.",
    blogWrite: "Write",
    blogEdit: "Edit",
    blogDelete: "Delete",
    blogDeleteConfirm: "Delete this post? This cannot be undone.",
    blogBack: "← Back to blog",
    blogUpdatedLabel: "updated",
    blogEditorTitleNew: "New Post",
    blogEditorTitleEdit: "Edit Post",
    blogFieldTitle: "Title",
    blogFieldSlug: "Slug (URL, lowercase + hyphens)",
    blogFieldTags: "Tags (comma-separated, max 5)",
    blogFieldBody: "Body (markdown)",
    blogPreview: "Preview",
    blogEditorHint:
      "Markdown supported: headings (#), bold (**), code (```), links, images, lists, quotes (>)",
    blogPublish: "Publish",
    blogSaveDraft: "Save draft (private)",
    blogSaving: "Saving…",
    blogSaved: "Saved!",
